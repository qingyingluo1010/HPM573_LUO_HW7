...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._survivalBeyond5 =[]
        self._survival5years = []
        # populate the cohort
    ...
    def simulate(self, n_time_steps):
        ...
        for patient in self._patients:
            ...
            if value>5:
                self._survival5years.append(value)

        # beyond 5 years
        for k in self._survivalTimes:
            if k>5:
                self._survivalBeyond5.append(1)
    ...
    def get_beyond(self):
        return self._survivalBeyond5

    def get_survival_5years(self):
        return self._survival5years

    def get_percentage_of_patients_survived_beyond_5_years(self):

        return len(self._survivalBeyond5)/ self._initialPopSize
...
class CohortOutcomes:
    def __init__(self, simulated_cohort):
        ...
        self._sumStat_patientSurvivalBeyond5=\
            Stat.SummaryStat('Patient survival times', self._simulatedCohort.get_survival_5years())
    ...
    def get_ave_5year_survival_time(self):
        return self._sumStat_patientSurvivalBeyond5.get_mean()
    ...
    def get_beyond5s(self):
        return self._simulatedCohort.get_beyond()

    def get_percentage(self):
        return len(self._simulatedCohort.get_beyond())/len(self._simulatedCohort.get_survival_times())
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._meansurvival5years = []
        self._sumStat_meanSurvivalTime = None
        self._sumStat_meansurvival5years = None
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            self._survival5years.append(cohort.get_survival_5years())
            # store average survival time for this cohort
            self._meanSurvivalTimes.append(output.get_ave_survival_time())
            self._meansurvival5years.append(output.get_ave_5year_survival_time())
        ...
        self._sumStat_meansurvival5years = Stat.SummaryStat('Mean 5 year survival time', self._meansurvival5years)
    ...
    def get_cohort_mean_5years(self, cohort_index):
        return self._meansurvival5years[cohort_index]
    ...
    def get_all_mean_5years(self):
        return self._meansurvival5years
    ...
    def get_overall_mean_5years(self):
        return self._sumStat_meansurvival5years.get_mean()
    ...
    def get_cohort_PI_5years(self, cohort_index, alpha):
        ts = Stat.SummaryStat('', self._survival5years[cohort_index])
        return ts.get_PI(alpha)
    ...
    def get_PI_mean_5years(self, alpha):
        return self._sumStat_meansurvival5years.get_PI(alpha)
...
print('The percentage of patients survived beyond 5 years is:', cohortOutcome.get_percentage())
