...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            mean = multiCohort.get_cohort_mean_5years(cohort_id)
            ...
            weight = stat.norm.pdf(
                x=CalibSets.OBS_MEAN2,
                loc=mean,
                scale=CalibSets.OBS_STDEV2)
...
class CalibratedModel:
    ...
    def get_all_mean_5years(self):
        ...
        return self._multiCohorts.get_all_mean_5years()

    def get_mean_survival_5years_proj_interval(self, alpha, deci):
        """
        :param alpha: the significance level
        :param deci: decimal places
        ...
        mean = self._multiCohorts.get_overall_mean_5years()
        proj_interval = self._multiCohorts.get_PI_mean_5years(alpha)
